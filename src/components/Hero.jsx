        ...
        <div className="px-16 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#contact"
                className="bg-orange-500 text-white px-8 py-3 rounded-full font-medium hover:bg-orange-600 transition-colors inline-flex items-center justify-center"
              >
                Get Started
              ...
              <a
                href="#portfolio"
                className="border-2 border-gray-800 text-gray-800 px-8 py-3 rounded-full font-medium hover:bg-gray-800 hover:text-white transition-colors inline-flex items-center justify-center"
              >
                View Our Work
              </a>
            </div>
